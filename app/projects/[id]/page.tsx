    ...
    return (
        <div className="min-h-screen bg-primary-custom p-4 md:p-6">
            <div className="max-w-5xl mx-auto">
                {/* Back Button */}
                <Link href="/projects">
                    <button className="group flex items-center gap-2 mb-6 text-secondary-custom hover:text-primary-custom transition-colors duration-200 bg-secondary-custom px-4 py-2 rounded-lg border border-secondary-custom"
